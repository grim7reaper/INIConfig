...
placed into a default section called <i>Default</i>. The name of this section can be
...
The comment character can be either a semicolon <b>;</b> or a number sign
<b>#</b>. The comment character can appear anywhere on a line including at the
...
When parsing, the trailing slash will be consumed and <b>will not</b> appear in
...
Some escape characters are supported within the <b>value</b> for an option.
